defmodule MybookmarksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MybookmarksWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MybookmarksWeb.Gettext, "errors", msg, opts)
    end
  end
